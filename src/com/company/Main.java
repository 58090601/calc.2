...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        double result = 0;
        String inputString;
        try (BufferedReader br = new BufferedReader(new FileReader("C://kkk//input.txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("C://kkk//output.txt"))) {
